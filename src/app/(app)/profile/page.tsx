...
export default async function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <Card>
        <CardContent className="flex flex-col items-center gap-5 p-8 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0 flex-1 text-center sm:text-left">
            ...
            <div className="mt-2 flex flex-col items-center gap-y-1 text-sm text-muted-foreground sm:items-start">
