...
const faqs = [
  ...
  },
  {
    ...
    a: "StudyAI uses NVIDIA's DeepSeek V4 Flash — a fast, powerful model ideal for summarizing long documents and generating study tools. OCR transcription uses a separate vision model.",
  },
  {
